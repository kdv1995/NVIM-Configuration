...
-- Function to show diagnostics automatically as inline text only
...
-- 		float = false, -- Ensure float windows aren't shown automatically
-- 	})
--
-- 	-- Create autocommands for displaying diagnostics (without float)
-- 	vim.api.nvim_create_autocmd({ "BufWritePost", "BufEnter", "CursorHold" }, {
-- 		pattern = { "*" },
-- 		callback = function()
-- 			-- Comment out or remove the following line to disable float windows
