...
vim.keymap.set("n", "<leader>fb", telescope_builtin.git_branches, { desc = "Telescope git branches" })
vim.keymap.set("n", "<leader>fs", telescope_builtin.git_status, { desc = "Telescope git status" })
